  ...
  return (
    <Layout>
      <div className='text-left'>
        ...
        <p>
          Welcome to the story of Sadhana, a tale of transformation. This isn't
          just any story. It's my story. It's a chronicle of how I learned to
          code, to meditate, and to harness the power of consistency to fuel my
          personal growth. It's about the journey from engineering school
          through a masters in innovation, and it's about realizing that the
          world we live in places an overwhelming value on birthright
          opportunities.
        </p>
        ...
        <p>
          ...
          world. It's a testament to the value of perseverance and consistent
          effort, and it's the foundation upon which Sadhana is built.
        </p>
        ...
        <div className='flex flex-col items-center my-8'>
          <Image
            ...
            height={900} // replace with your image's height
            className='rounded'
          />
        ...
        <p>
          ...
          expectations. It's about embracing our past and using it as a stepping
          stone towards a new future. It's about kindling the creative spark
          within each one of us, about rekindling our connection with our inner
          child.
        </p>
        ...
        <p>
          Creativity is not about right or wrong. It's about exploration, about
          pushing boundaries, about being pleasantly surprised by the outcome.
          It's about playing.
        </p>

        <p>
          Through play, we can learn to be present, to just 'be.' This is the
          essence of Sadhana, the vision that I want to bring into reality. I
          believe that creativity and play are the keys to our true selves, to
          our inner children.
        </p>

        <p>
          I invite you to join me in this journey. Let's write a new story
          together, a story of acceptance and creativity. Let's build a world
          where our children are seen as the wise ones, where we learn from them
          rather than dictating their paths.
        </p>
        ...
        <p>
          ...
          Your feedback and support mean the world to me. And, if you're ready
          to take the leap, visit{' '}
