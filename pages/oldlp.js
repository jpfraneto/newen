      ...
      <main className='bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 min-h-screen'>
        ...
        {/*<section className='bg-gradient-to-r from-cyan-500 to-blue-500 flex justify-center py-20'>
          <div className='text-black	 card mx-4 p-4 bg-gray-100 border border-gray-300 rounded-lg text-center w-1/4'>
            <h3 className='text-4xl font-bold mb-3'>Connection</h3>
            <p className='text-xl'>
          ...
          <div className='text-black	card mx-4 p-4 bg-gray-100 border border-gray-300 rounded-lg text-center w-1/4'>
            <h3 className='text-4xl font-bold mb-3'>Consistency</h3>
            <p className='text-xl'>
              Practice doing the craft that makes this creator be awesome, with
              an gamified accountability system..
            </p>
          </div>
          <div className='text-black	card mx-4 p-4 bg-gray-100 border border-gray-300 rounded-lg text-center w-1/4'>
            <h3 className='text-4xl font-bold mb-3'>Evolution</h3>
            <p className='text-xl'>
