...
- Periodicity: ${sadhana.periodicity}
- Starting date: ${new Date(sadhana.startingTimestamp).toLocaleDateString()}

To help you get started and make the most out of your Sadhana experience, I've prepared a video tutorial for you. Check it out: ${videoLink}
